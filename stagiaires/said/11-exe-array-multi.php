...
// affiche avec un echo les domaine de la variable  $webdev_2025 ci dessus pour nous afficher le githib de Mykyta
...
// affiche de trois ! tableaux indexes dans les tableaux associatifs 
echo  $webdev_2025["WEBDEV04"]["Sites"] ["bla"] [2];
