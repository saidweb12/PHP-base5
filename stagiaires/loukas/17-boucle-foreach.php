...
echo '1) Affichez les lettres de $tab avec une boucle foreach <br>';
$tab = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j'];
foreach ($tab as $char) {
  echo $char . " ";
}

echo '<br> <br> 2) Affichez les lettres de $tab avec une boucle foreach en affichant aussi la clef de chaque élément <br>';
$tab = range('a', 'j');
foreach ($tab as $clef => $char) {
  echo "$clef=> $char" . " ";
}

echo '<br> <br> 3) Affichez les jours de la semaine avec une boucle foreach en affichant aussi la clef de chaque élément <br>';
$semain = array(
  1 => "lundi",
  2 => "mardi",
  3 => "mercredi",
...
foreach ($semain as $clef => $jour) {
  echo "$clef => $jour" . " ";
}

echo '<br> <br> 4) Affichez le jour actuel de la semaine en français avec la fonction date() et la variable $semaine Fr <br>';
$semain = array(
  "Monday" => "Lundi",
  "Tuesday" => "Mardi",
  "Wednesday" => "Mercredi",
...
echo '<br> <br> 5) Affichez la liste des prénoms du tableau $classe avec une boucle foreach <br>';
$classe = array("Jean", "Eric", "Marie", "Julie", "Luc", "Pierre", "Paul", "Jacques", "Hélène", "Anne");

foreach ($classe as $nom) {
  echo $nom . " ";
}
echo "<br> <br> 6) Affichez la liste des 'nom', 'age' et 'note' du tableau Sclasse 18 avec une boucle foreach avec un retour à la ligne entre chaque élément <br>";
$students = array(
  array("nom" => "Élève 1", "âge" => 15, "note" => 90),
  array("nom" => "Élève 2", "âge" => 16, "note" => 80),
  array("nom" => "Élève 3", "âge" => 15, "note" => 100),
  array("nom" => "Élève 4", "âge" => 17, "note" => 70),
  array("nom" => "Élève 5", "âge" => 16, "note" => 95),
  array("nom" => "Élève 6", "âge" => 15, "note" => 85),
  array("nom" => "Élève 7", "âge" => 17, "note" => 75),
  array("nom" => "Élève 8", "âge" => 16, "note" => 90),
  array("nom" => "Élève 9", "âge" => 15, "note" => 80),
  array("nom" => "Élève 10", "âge" => 17, "note" => 100),
  array("nom" => "Élève 11", "âge" => 16, "note" => 70),
  array("nom" => "Élève 12", "âge" => 15, "note" => 95),
  array("nom" => "Élève 13", "âge" => 17, "note" => 85),
  array("nom" => "Élève 14", "âge" => 16, "note" => 75),
  array("nom" => "Élève 15", "âge" => 15, "note" => 90),
  array("nom" => "Élève 16", "âge" => 17, "note" => 80),
  array("nom" => "Élève 17", "âge" => 16, "note" => 95),
  array("nom" => "Élève 18", "âge" => 15, "note" => 85)
);

foreach ($students as $student) {
  $studentName = $student["nom"];
  $studentAge = $student["âge"];
  $studentNote = $student["note"];
  echo "nom => $studentName | âge => $studentAge | note: $studentNote <br>";
}

echo '<br> <br> 7) Avec 2 boucles foreach, affichez tous les champs la liste des pays du tableau $countryCode<br>';
