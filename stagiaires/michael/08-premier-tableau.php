...
// entre simple guillemets, les variables ne sont pas interprétées
echo '$classe1[4] $classe1[5]<hr>';
// entre double guillemets, les variables sont interprétées quand il n'y a pas de guillemets dans les variables PHP, on les échapes avec {$var}
